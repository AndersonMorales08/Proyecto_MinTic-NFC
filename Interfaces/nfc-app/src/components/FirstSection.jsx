...
export const FirstSection = () => {
    return (
        <>
        <section className="pt-3 pb-5 bg-light" id="vehiculos">
            <div>
                <div className="p-5" style={{height:510}}>
                    <h2>Vehiculos</h2>
                    ...
                    <div className="tab-content" id="pills-tabContent">
                        <div className="tab-pane fade show active" id="pills-carro" role="tabpanel"
                            ...
                            <div className="row m-3">
                                <div className="col-4 d-flex align-items-center justify-content-center"><a href="#"><img
                                            className="rounded-3 articulo" src="Sources/Carro1.jpg" alt="" srcset="" /></a>
                                </div>
                                <div className="col-4 d-flex align-items-center justify-content-center"><a href="#"><img
                                            className="rounded-3 articulo" src="Sources/Carro1.jpg" alt="" srcset="" /></a>
                                </div>
                        ...
                        <div className="tab-pane fade" id="pills-camioneta" role="tabpanel"
                            ...
                            <div className="row m-3">
                                <div className="col-4 d-flex align-items-center justify-content-center"><a href="#"><img
                                            className="rounded-3 articulo" src="Sources/camioneta1.jpg" alt=""
                                            srcset="" /></a></div>
                                <div className="col-4 d-flex align-items-center justify-content-center"><a href="#"><img
                                            className="rounded-3 articulo" src="Sources/camioneta1.jpg" alt=""
                                            srcset="" /></a></div>
                        ...
                        <div className="tab-pane fade" id="pills-suv" role="tabpanel" aria-labelledby="pills-suv-tab">
                            <div className="row m-3">
                                <div className="col-4 d-flex align-items-center justify-content-center"><a href="#"><img
                                            className="rounded-3 articulo" src="Sources/suv1.jpg" alt="" srcset="" /></a>
                                </div>
                                <div className="col-4 d-flex align-items-center justify-content-center"><a href="#"><img
                                            className="rounded-3 articulo" src="Sources/suv1.jpg" alt="" srcset="" /></a>
                                </div>
                        ...
                        <div className="tab-pane fade" id="pills-deportivo" role="tabpanel"
                            ...
                            <div className="row m-3">
                                <div className="col-4 d-flex align-items-center justify-content-center"><a href="#"><img
                                            className="rounded-3 articulo" src="Sources/deportivo1.jpg" alt=""
                                            srcset="" /></a></div>
                                <div className="col-4 d-flex align-items-center justify-content-center"><a href="#"><img
                                            className="rounded-3 articulo" src="Sources/GoogleIcon.png" alt=""
                                            srcset="" /></a></div>
                                <div className="col-4 d-flex align-items-center justify-content-center"><a href="#"><img
                                            className="rounded-3 articulo" src="Sources/GoogleIcon.png" alt=""
                                            srcset="" /></a></div>
